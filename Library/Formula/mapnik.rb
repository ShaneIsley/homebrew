...
class Mapnik < Formula
  ...
  def install
    ...
    system 'scons', "PREFIX=#{prefix}",
        ...
        "TIFF_INCLUDES=#{HOMEBREW_PREFIX}/include", "TIFF_LIBS=#{HOMEBREW_PREFIX}/lib",
        "JPEG_INCLUDES=#{HOMEBREW_PREFIX}/include", "JPEG_LIBS=#{HOMEBREW_PREFIX}/lib",
        "PROJ_INCLUDES=#{HOMEBREW_PREFIX}/include", "PROJ_LIBS=#{HOMEBREW_PREFIX}/lib",
        "BOOST_INCLUDES=#{HOMEBREW_PREFIX}/include", "BOOST_LIBS=#{HOMEBREW_PREFIX}/lib",
        "install"
  end
end
